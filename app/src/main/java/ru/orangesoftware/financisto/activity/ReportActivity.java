...
public class ReportActivity extends ListActivity implements RefreshSupportedActivity {
    ...
    private class PieChartGeneratorTask extends AsyncTask<Void, Void, Intent> {
        ...
        private void addSeries(CategorySeries series, DefaultRenderer renderer, String name, BigDecimal expense,
                long total, int color) {
    ...
    private void loadFilter() {
        ...
        incomeExpenseState = IncomeExpense
                .valueOf(preferences.getString(FILTER_INCOME_EXPENSE, IncomeExpense.BOTH.name()));
        saveFilter = true;
    }
