...
public class FinancistoService extends JobIntentService {
    ...
    public static final String ACTION_SCHEDULE_AUTO_BACKUP
    ...
    private Notification generateNotification(TransactionInfo t, String tickerText, String contentTitle,
            String text) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, (int) t.id, notificationIntent,
                FLAG_CANCEL_CURRENT); /* https://stackoverflow.com/a/3730394/365675 */
