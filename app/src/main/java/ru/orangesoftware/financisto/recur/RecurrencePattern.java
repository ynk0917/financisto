        ...
        switch (frequency) {
            ...
            case MONTHLY:
                ...
                MonthlyPattern pattern = MonthlyPattern
                        .valueOf(state.get(RecurrenceViewFactory.P_MONTHLY_PATTERN + "_0"));
                switch (pattern) {
                    case EVERY_NTH_DAY:
                        int everyNthDay = Integer
                                .parseInt(state.get(RecurrenceViewFactory.P_MONTHLY_PATTERN_PARAMS + "_0"));
