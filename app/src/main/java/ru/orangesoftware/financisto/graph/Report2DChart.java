...
public abstract class Report2DChart {
    ...
    /**
     * Get the default start period based on the periodLength, considering the current month the last month of the
     * period.
     *
     ...
     * @param currency     The reference currency to filter transactions in same currency
     */
    public Report2DChart(Context context, MyEntityManager em, Calendar startPeriod, int periodLength,
            Currency currency) {
        init(context, em, startPeriod, periodLength, currency);
    }
     ...
     *
     * @return True if there is data to plot or False if there is no points or if all the points have no value
     * different of zero.
     */
     ...
     * @param currency     The reference currency to filter transactions in same currency
     */
    public void rebuild(Context context, MyEntityManager em, Calendar startPeriod, int periodLength,
            Currency currency) {
        init(context, em, startPeriod, periodLength, currency);
    }
    ...
    protected void build() {
        data = new ReportDataByPeriod(context, startPeriod, periodLength, currency, columnFilter,
                filterIds.get(currentFilterOrder).intValue(), em);
     ...
     * @param periodLength The number of months to plot the chart
     */
    private void init(Context context, MyEntityManager em, Calendar startPeriod, int periodLength,
            Currency currency) {
