...
public class Report2DChartActivity extends Activity {
    ...
    private void fillStatistics() {
        ...
        // chart limits
        ((TextView) findViewById(R.id.report_max_result))
                .setText(Utils.amountToString(reportData.getCurrency(), max.longValue()));
        ((TextView) findViewById(R.id.report_min_result))
                .setText(Utils.amountToString(reportData.getCurrency(), min.longValue()));
        // sum and mean
        ((TextView) findViewById(R.id.report_mean_result))
        ...
        ((TextView) findViewById(R.id.report_sum_result))
                .setText(Utils.amountToString(reportData.getCurrency(), sum.longValue()));
    }
