...
public class DatabaseHelper extends DatabaseSchemaEvolution {
    ...
    public static class ReportColumns {
        ...
        public static String[] NORMAL_PROJECTION = {ID, NAME, DATETIME, FROM_ACCOUNT_CURRENCY_ID, FROM_AMOUNT,
                TO_ACCOUNT_CURRENCY_ID, TO_AMOUNT, ORIGINAL_CURRENCY_ID, ORIGINAL_FROM_AMOUNT, IS_TRANSFER};
    ...
    public static class SubCategoryReportColumns extends ReportColumns {
        ...
        public static String[] NORMAL_PROJECTION = {ID, NAME, DATETIME, FROM_ACCOUNT_CURRENCY_ID, FROM_AMOUNT,
                TO_ACCOUNT_CURRENCY_ID, TO_AMOUNT, ORIGINAL_CURRENCY_ID, ORIGINAL_FROM_AMOUNT, LEFT, RIGHT,
                IS_TRANSFER};
    }
    ...
    public static enum ExchangeRateColumns {
        ...
        public static String NORMAL_PROJECTION_WHERE = from_currency_id + "=? and " + to_currency_id + "=? and "
                + rate_date + "=?";
    }
