...
public class CsvImportOptions {
    ...
    public static CsvImportOptions fromIntent(Intent data) {
        ...
        return new CsvImportOptions(currency, dateFormat, selectedAccountId, filter, filename, fieldSeparator,
                useHeaderFromFile);
    }

    public CsvImportOptions(Currency currency, String dateFormat, long selectedAccountId, WhereFilter filter,
            String filename, char fieldSeparator, boolean useHeaderFromFile) {
