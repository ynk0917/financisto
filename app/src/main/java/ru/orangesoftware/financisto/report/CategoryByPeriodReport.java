...
public class CategoryByPeriodReport extends Report2DChart {
    ...
    public CategoryByPeriodReport(Context context, MyEntityManager em, Calendar startPeriod, int periodLength,
            Currency currency) {
    ...
    protected void build() {
        ...
        if (addSubs) {
            ...
            try {
                ...
                cursor = db
                        .query(DatabaseHelper.CATEGORY_TABLE, new String[]{CategoryColumns._id.name()}, where, pars,
                                null, null, null);
                ...
                data = new ReportDataByPeriod(context, startPeriod, periodLength, currency, columnFilter, categories,
                        em);
            } finally {
                if (cursor != null) {
                    cursor.close();
