...
class EntityDefinition {
    ...
    static class Builder {
        ...
        EntityDefinition create() {
            ...
            return new EntityDefinition(constructor, tableName, idField,
...
//	}
    ...
    protected void prepareSqlQuery(EntityDefinition ed, StringBuilder sbColumns, StringBuilder sbJoins, String pe,
            boolean required) {
        FieldInfo[] fields = ed.fields;
        for (FieldInfo f : fields) {
            if (f.type.isPrimitive()) {
                ...
                sbJoins.append(isRequired ? " inner join " : " left outer join ").append(edJoin.tableName)
                        .append(" as ").append(e);
                sbJoins.append(" on ").append(e).append(".").append(ed.idField.columnName).append("=").append(pe)
                        .append(".").append(f.columnName);
    ...
    private FieldInfo getFieldInfo(String field) {
        ...
        if (f == null) {
            throw new IllegalArgumentException(
                    "Unknown field [" + field + "] for " + constructor.getDeclaringClass());
        }
        return f;
    }
