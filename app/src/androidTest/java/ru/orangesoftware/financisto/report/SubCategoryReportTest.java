...
public class SubCategoryReportTest extends AbstractReportTest {
    ...
    public void test_should_calculate_correct_report_with_multiple_currencies_1() {
        ...
        TransactionBuilder.withDb(db).account(a1).category(categories.get("A")).dateTime(DateTime.today())
                .amount(-120).create();
        TransactionBuilder.withDb(db).account(a3).category(categories.get("A")).dateTime(DateTime.today())
                .amount(-100).create();
    ...
    public void test_should_calculate_correct_report_with_multiple_currencies_2() {
        ...
        TransactionBuilder.withDb(db).account(a1).category(categories.get("A1")).dateTime(DateTime.today())
                .amount(-100).create();
        TransactionBuilder.withDb(db).account(a3).category(categories.get("A2")).dateTime(DateTime.today())
                .amount(250).create();
    ...
    public void test_should_calculate_correct_report_with_one_currency_2() {
        ...
        TransactionBuilder.withDb(db).account(a1).category(categories.get("A1")).dateTime(DateTime.today())
                .amount(4000).create();
        TransactionBuilder.withDb(db).account(a1).category(categories.get("AA1")).dateTime(DateTime.today())
                .amount(1000).create();
        TransactionBuilder.withDb(db).account(a1).category(categories.get("A2")).dateTime(DateTime.today())
                .amount(1500).create();
        List<GraphUnit> units = assertReportReturnsData();
