...
public class SmsTransactionProcessorTest extends AbstractDbTest {
    ...
    public void testDebitTransactionBySberSms() throws Exception {
        ...
        SmsTemplateBuilder.withDb(db).title("900").accountId(17).categoryId(18).template(smsTpl).income(true)
                .create();
    ...
    public void testFindingPlaceholderIndexes() throws Exception {
        int[] indexes = SmsTransactionProcessor.findPlaceholderIndexes(
                "Pokupka. Karta *<:A:>. Summa <:P:> RUB. NOVYY PROEKT, MOSCOW. <:D:>. Dostupno <:B:> RUB. Tinkoff.ru");
        ...
        indexes = SmsTransactionProcessor
                .findPlaceholderIndexes("ECMC<:A:> <:D:> покупка <:P:> TEREMOK METROPOLIS Баланс: <:B:>р");
        Assert.assertTrue(indexes[Placeholder.ACCOUNT.ordinal()] == 0);
        ...
        indexes = SmsTransactionProcessor
                .findPlaceholderIndexes("ECMC<:A:> <:D:> покупка <:P:> TEREMOK METROPOLIS Баланс:");
        Assert.assertTrue(indexes[Placeholder.ACCOUNT.ordinal()] == 0);
        Assert.assertTrue(indexes[Placeholder.DATE.ordinal()] == 1);
        Assert.assertTrue(indexes[Placeholder.PRICE.ordinal()] == 2);
        ...
        indexes = SmsTransactionProcessor
                .findPlaceholderIndexes("ECMC<:A:> <:D:><::> <:P:> TEREMOK METROPOLIS Баланс:");
    ...
    public void testMultilineSms() throws Exception {
        ...
        String sms
                = "Pokupka. Karta *5631. Summa 1250,77 RUB. NOVYY PROEKT, MOSCOW. 02.10.2017 14:19. Dostupno 34 202.82 RUB.\nTinkoff\n.ru";

        String[] matches = SmsTransactionProcessor.findTemplateMatches(template, sms);

        Assert.assertArrayEquals(new String[]{null, "5631", "34 202.82 ", "02.10.2017 14:19", "1250,77", null},
                matches);
    }
    ...
    public void testTemplateWithSpecialChars() throws Exception {
        ...
        String sms
                = "ECMC5431 01.10.17 19:50 покупка 555р TE{{R}}E{{MOK ME}TROP<:P:OL?$()[]/\\.*IS Баланс: 49820.45р";
    ...
    public void testTemplatesWithDifferentLength() throws Exception {
        ...
        String sms
                = "Pokupka. Karta *5631. Summa 250.77 RUB. NOVYY PROEKT, MOSCOW. 02.10.2017 14:19. Dostupno 34202.82 RUB. Tinkoff.ru";
    ...
    public void testTransactionByTinkoffSms() throws Exception {
        String template = "*{{a}}. Summa {{P}} RUB. NOVYY PROEKT, MOSCOW. {{D}}. Dostupno {{b}}";
        String sms
                = "Pokupka. Karta *5631. Summa 1234567.20 RUB. NOVYY PROEKT, MOSCOW. 02.10.2017 14:19. Dostupno 34202.70 RUB. Tinkoff.ru";

        String[] matches = SmsTransactionProcessor.findTemplateMatches(template, sms);

        Assert.assertArrayEquals(new String[]{null, "5631", "34202.70 ", "02.10.2017 14:19", "1234567.20", null},
                matches);
    ...
    public void testUniversalPrices() throws Exception {
        ...
        String sms
                = "Pokupka. Karta *5631. Summa 1 250,77 RUB. NOVYY PROEKT, MOSCOW. 02.10.2017 14:19. Dostupno 34,202.82 RUB. Tinkoff.ru";

        String[] matches = SmsTransactionProcessor.findTemplateMatches(template, sms);

        Assert.assertArrayEquals(new String[]{null, "5631", "34,202.82", "02.10.2017 14:19", "1 250,77", null},
                matches);
