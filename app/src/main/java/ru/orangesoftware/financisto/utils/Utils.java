...
public class Utils {
    ...
    public static TextAppearanceSpan getAmountSpan(Context context, long amount) {
        return new TextAppearanceSpan(context,
                amount == 0
                        ...
                        : (amount > 0 ? R.style.TextAppearance_Financisto_PositiveAmount
                                : R.style.TextAppearance_Financisto_NegativeAmount));
    }
    ...
    public static String locationToText(String provider, double latitude, double longitude, float accuracy,
    ...
    public void setAmountText(StringBuilder sb, TextView view, Currency originalCurrency, long originalAmount,
            Currency currency, long amount, boolean addPlus) {
    ...
    public void setTransferAmountText(TextView textView, Currency fromCurrency, long fromAmount, Currency toCurrency,
            long toAmount) {
        textView.setText(getTransferAmountText(fromCurrency, fromAmount, toCurrency, toAmount));
        setTransferTextColor(textView);
    }

    public void setTransferBalanceText(TextView textView, Currency fromCurrency, long fromBalance,
            Currency toCurrency, long toBalance) {
        sb.setLength(0);
