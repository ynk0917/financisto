...
public class AccountWidget extends AppWidgetProvider {
    ...
    private static RemoteViews buildUpdateForCurrentAccount(Context context, int widgetId, int layoutId,
            Class providerClass, long accountId) {
    ...
    private static RemoteViews updateWidgetFromAccount(Context context, int widgetId, int layoutId,
            Class providerClass, Account a) {
        ...
        if (type.isCard && a.cardIssuer != null) {
            ...
            ElectronicPaymentType paymentType = selectEnum(ElectronicPaymentType.class, a.cardIssuer,
