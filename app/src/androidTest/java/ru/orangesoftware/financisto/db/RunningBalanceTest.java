...
public class RunningBalanceTest extends AbstractDbTest {
    ...
    public void test_should_update_running_balance_for_account_which_has_transfer_to_the_same_account() {
        ...
        Transaction t3 = TransferBuilder.withDb(db).fromAccount(a1).fromAmount(-500).toAccount(a1).toAmount(500)
                .create();
        db.rebuildRunningBalances();
    ...
    public void test_should_update_running_balance_for_two_accounts() {
        Transaction t1 = TransactionBuilder.withDb(db).account(a1).amount(1000).create();
        Transaction t2 = TransactionBuilder.withDb(db).account(a2).amount(2000).create();
        Transaction t3 = TransferBuilder.withDb(db).fromAccount(a1).fromAmount(-500).toAccount(a2).toAmount(500)
                .create();
        db.rebuildRunningBalances();
        assertAccountBalanceForTransaction(t1, a1, 1000);
        assertAccountBalanceForTransaction(t2, a2, 2000);
    ...
    public void test_should_update_running_balance_when_deleting_existing_transaction() {
        ...
        // t3 | 12:00 | -250   | +250
        // t4 | 13:00 | -50    | +200
        Transaction t1 = TransactionBuilder.withDb(db).account(a1).amount(1000)
                .dateTime(DateTime.today().at(11, 0, 0, 0)).create();
        Transaction t2 = TransactionBuilder.withDb(db).account(a1).amount(-500)
                .dateTime(DateTime.today().at(11, 5, 0, 0)).create();
        Transaction t3 = TransactionBuilder.withDb(db).account(a1).amount(-250)
                .dateTime(DateTime.today().at(12, 0, 0, 0)).create();
        Transaction t4 = TransactionBuilder.withDb(db).account(a1).amount(-50)
                .dateTime(DateTime.today().at(13, 0, 0, 0)).create();
        db.rebuildRunningBalanceForAccount(a1);
        assertAccountBalanceForTransaction(t1, a1, 1000);
    ...
    public void test_should_update_running_balance_when_inserting_new_transaction() {
        ...
        Transaction t4 = TransactionBuilder.withDb(db).account(a1).amount(100)
                .dateTime(DateTime.today().at(13, 20, 0, 0)).create();
        assertAccountBalanceForTransaction(t1, a1, 1000);
        assertAccountBalanceForTransaction(t2, a1, 500);
        assertAccountBalanceForTransaction(t3, a1, 250);
        ...
        // t3 | 12:00 | -250   | +200
        // t4 | 13:20 | +100   | +300
        Transaction t5 = TransactionBuilder.withDb(db).account(a1).amount(-50)
                .dateTime(DateTime.today().at(11, 10, 0, 0)).create();
        assertAccountBalanceForTransaction(t1, a1, 1000);
        assertAccountBalanceForTransaction(t2, a1, 500);
        ...
        // t3 | 12:00 | -250   | +350
        // t4 | 13:20 | +100   | +450
        Transaction t6 = TransactionBuilder.withDb(db).account(a1).amount(150)
                .dateTime(DateTime.today().at(10, 0, 0, 0)).create();
    ...
    public void test_should_update_running_balance_when_inserting_new_transfer() {
        ...
        // t21 | 11:00 | +900   | +900
        // t22 | 12:00 | -100   | +800
        Transaction t11 = TransactionBuilder.withDb(db).account(a1).amount(1000)
                .dateTime(DateTime.today().at(11, 0, 0, 0)).create();
        Transaction t12 = TransactionBuilder.withDb(db).account(a1).amount(-500)
                .dateTime(DateTime.today().at(11, 5, 0, 0)).create();
        Transaction t13 = TransactionBuilder.withDb(db).account(a1).amount(-250)
                .dateTime(DateTime.today().at(12, 0, 0, 0)).create();
        db.rebuildRunningBalanceForAccount(a1);
        ...
        assertFinalBalanceForAccount(a1, 250);
        Transaction t21 = TransactionBuilder.withDb(db).account(a2).amount(900)
                .dateTime(DateTime.today().at(11, 0, 0, 0)).create();
        Transaction t22 = TransactionBuilder.withDb(db).account(a2).amount(-100)
                .dateTime(DateTime.today().at(13, 0, 0, 0)).create();
        ...
        // t22 | 13:00 | -100   | +900
        Transaction t14 = TransferBuilder.withDb(db).fromAccount(a1).fromAmount(-100).toAccount(a2).toAmount(100)
                .dateTime(DateTime.today().at(12, 30, 0, 0)).create();
        assertAccountBalanceForTransaction(t11, a1, 1000);
        assertAccountBalanceForTransaction(t12, a1, 500);
        assertAccountBalanceForTransaction(t13, a1, 250);
        ...
        // t22 | 13:00 | -100   | +900
        // t15 | 13:30 | +20    | +920 <- A1
        Transaction t15 = TransferBuilder.withDb(db).fromAccount(a1).fromAmount(-50).toAccount(a2).toAmount(20)
                .dateTime(DateTime.today().at(13, 30, 0, 0)).create();
    ...
    public void test_should_update_running_balance_when_updating_account_on_existing_transfer() {
        ...
        Transaction t11 = TransactionBuilder.withDb(db).account(a1).amount(1000)
                .dateTime(DateTime.today().at(11, 0, 0, 0)).create();
        Transaction t21 = TransactionBuilder.withDb(db).account(a2).amount(500)
                .dateTime(DateTime.today().at(12, 0, 0, 0)).create();
        Transaction t12 = TransferBuilder.withDb(db).fromAccount(a1).fromAmount(-100).toAccount(a2).toAmount(100)
                .dateTime(DateTime.today().at(12, 30, 0, 0)).create();
        Transaction t31 = TransactionBuilder.withDb(db).account(a3).amount(100)
                .dateTime(DateTime.today().at(13, 0, 0, 0)).create();
        db.rebuildRunningBalanceForAccount(a1);
        db.rebuildRunningBalanceForAccount(a2);
