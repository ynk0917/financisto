...
public class NotificationOptionsActivity extends AbstractActivity {
    ...
    private static final NotificationOptions.VibrationPattern[] patterns = NotificationOptions.VibrationPattern
            .values();
    ...
    public void createNodes() {
        ...
        soundText = x.addListNode(layout, R.id.notification_sound, R.string.notification_sound,
                options.getSoundName(this));
        vibraText = x
                .addListNode(layout, R.id.notification_vibra, R.string.notification_vibra, options.vibration.titleId);
    ...
    protected void onClick(View v, int id) {
        switch (id) {
            ...
            case R.id.notification_vibra: {
                ...
                x.selectPosition(this, R.id.notification_vibra, R.string.notification_vibra, adapter,
                        options.vibration.ordinal());
            }
            break;
            case R.id.notification_led: {
                ArrayAdapter<String> adapter = EnumUtils.createDropDownAdapter(this, colors);
                x.selectPosition(this, R.id.notification_led, R.string.notification_led, adapter,
                        options.ledColor.ordinal());
            }
            break;
            case R.id.result1: {
