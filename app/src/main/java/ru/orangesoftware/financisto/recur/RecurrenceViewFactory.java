...
public class RecurrenceViewFactory {
    ...
    abstract class AbstractMonthlyView extends AbstractView {
        ...
        public void createNodes(LinearLayout layout) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                patternText[i] = x.addListNode(layout, 100 + i, R.string.recurrence_monthly_pattern,
                ...
                switch (pattern[i]) {
                    case EVERY_NTH_DAY:
                        ...
                        break;
                    case SPECIFIC_DAY:
                        specificDayText[i] = x.addListNode(layout, 200 + i, R.string.recurrence_monthly_specific_day,
                                specificDayStr(i));
                        break;
                }
            }
    ...
    private class WeeklyView extends AbstractView {
        ...
        public void createNodes(LinearLayout layout) {
            ...
            daysOfWeekText = x
                    .addListNode(layout, R.id.recurrence_pattern, R.string.recurrence_weekly_days, daysToString());
        }
    ...
    private static final int[] DAY_TITLES = {R.string.recur_interval_semi_monthly_1,
