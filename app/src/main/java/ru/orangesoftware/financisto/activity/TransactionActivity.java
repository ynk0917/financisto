...
public class TransactionActivity extends AbstractTransactionActivity {
    ...
    protected void createListNodes(LinearLayout layout) {
        ...
        if (!isUpdateBalanceMode && MyPreferences.isShowCurrency(this)) {
            currencyText = x.addListNode(layout, R.id.original_currency, R.string.currency,
    ...
    private void createSplitsLayout(LinearLayout layout) {
        ...
        layout.addView(splitsLayout, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
    ...
    private void prepareUnsplitActionGrid() {
        ...
        unsplitActionGrid
                .addQuickAction(new MyQuickAction(this, R.drawable.ic_action_tick, R.string.unsplit_adjust_amount));
        unsplitActionGrid
                .addQuickAction(new MyQuickAction(this, R.drawable.ic_action_tick, R.string.unsplit_adjust_evenly));
        unsplitActionGrid
                .addQuickAction(new MyQuickAction(this, R.drawable.ic_action_tick, R.string.unsplit_adjust_last));
