...
public class MonthlyViewPlanner extends AbstractPlanner {
    ...
    public MonthlyViewPlanner(DatabaseAdapter db, Account account, boolean isStatementPreview, Date startDate,
    ...
    private static WhereFilter createMonthlyViewFilter(Date startDate, Date endDate, Account account) {
        ...
        filter.eq(Criteria.raw("(" + DatabaseHelper.TransactionColumns.parent_id + "=0 OR "
                + DatabaseHelper.BlotterColumns.is_transfer + "=-1)"));
